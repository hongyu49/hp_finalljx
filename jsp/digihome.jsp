		...
		-->
			<div data-role="content" align="center">
                ...
                <div class="ui-grid-b">
					...
					<div class="ui-block-b">
						<a href="javascript:void(0)" onclick="changePageWithBridge('http://mobile.sugon.com/view/baidu/news/','http://mobile.sugon.com/view/Resources/news.scene.xml')">
                        <img width="68" height="68" src="/view/png/digi/notice.png" />
						</a>
                        <br/>
                        <span style="color:white;"><strong>百度NEWS</strong></span>
                    </div>
					<div class="ui-block-c">
						<a href="javascript:void(0)" onclick="changePageWithBridge('http://mobile.sugon.com/view/test/first/','http://mobile.sugon.com/view/Resources/first.scene.xml')">
                        <img width="68" height="68" src="/view/png/digi/notice.png" />
						</a>
                        <br/>
                        <span style="color:white;"><strong>登陆首页</strong></span>
                    </div>
					
					<div class="ui-block-c">
						<a href="javascript:void(0)" onclick="changePageWithBridge('http://mobile.sugon.com/view/test2/second/','http://mobile.sugon.com/view/Resources/second.scene.xml')">
                        <img width="68" height="68" src="/view/png/digi/notice.png" />
						</a>
                        <br/>
                        <span style="color:white;"><strong>赋值页面</strong></span>
                    </div>
                </div>
